...
module TipsUtils {
    ...
    //从下到上弹出
    export function showTipsDownToUp(str:string = "",isWarning:boolean = false,fSize:number=24,xPoint:number,yPoint:number):void{
    ...
    //从左至右 或者 从右至左
    export function showTipsLeftOrRight(str:string = "",isWarning:boolean = false,isFromeLeft:boolean = true,fSize:number=24,xPoint:number,yPoint:number):void{
        var effectTips = new egret.TextField();
    ...
    //从里到外
    export function showTipsFromCenter(str:string = "",isWarning:boolean = false,
            fSize:number=24,xPoint:number,yPoint:number,callback?: Function):void{
        var effectTips = new egret.TextField();
    ...
    //从外到里
    export function showTipsBigToSmall(str:string = "",isWarning:boolean = false,fSize:number=24,xPoint:number,yPoint:number):void{
        var effectTips = new egret.TextField();
