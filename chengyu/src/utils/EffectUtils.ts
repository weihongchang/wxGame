...
module EffectUtils {
    ...
    */
    export function showTips(str:string = "",effectType:number = 1,fSize:number=24,
                isWarning:boolean = false,xPoint:number = 100,yPoint:number=100,callback?: Function):void{
        switch (effectType)
        {
            case 1: {
